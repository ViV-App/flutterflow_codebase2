import '/components/card_consulta/card_consulta_widget.dart';
                      ...
                      children: [
                        ...
                        Expanded(
                          child: Container(
                            ...
                            child: Builder(
                              builder: (context) {
                                final abuba = _model.list.toList();
                                return ListView.builder(
                                  ...
                                  itemCount: abuba.length,
                                  itemBuilder: (context, abubaIndex) {
                                    final abubaItem = abuba[abubaIndex];
                                    return Padding(
                                      padding: const EdgeInsetsDirectional.fromSTEB(
                                          18.0, 0.0, 18.0, 0.0),
                                      child: CardConsultaWidget(
                                        key: Key(
                                            'Keya2s_${abubaIndex}_of_${abuba.length}'),
                                      ),
                                    );
                                  },
                                );
