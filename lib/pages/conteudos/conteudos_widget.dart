                            ...
                            Expanded(
                              child: FutureBuilder<List<StaticConteudosRow>>(
                                future: (_model.requestCompleter1 ??=
                                        Completer<List<StaticConteudosRow>>()
                                          ..complete(
                                              StaticConteudosTable().queryRows(
                                            queryFn: (q) => q,
                                          )))
                                    .future,
                                builder: (context, snapshot) {
                                                                    ...
                                                                    child:
                                                                      ...
                                                                      children: [
                                                                        Text(
                                                                          valueOrDefault<
                                                                              String>(
                                                                            listViewStaticConteudosRow.titulo,
                                                                            '-',
                                                                          ),
                                                                        ...
                                                                        Text(
                                                                          '${listViewStaticConteudosRow.tempoLeitura?.toString()}min de leitura',
                                                                          style: FlutterFlowTheme.of(context)
                                                                              .bodyMedium
                                                                              .override(
                                                                                fontFamily: 'Mulish',
