...
class QuestionarioPerguntasTable
    extends SupabaseTable<QuestionarioPerguntasRow> {
  @override
  String get tableName => 'questionario_perguntas';

  @override
  QuestionarioPerguntasRow createRow(Map<String, dynamic> data) =>
      QuestionarioPerguntasRow(data);
}
