                                  ...
                                  Align(
                                    ...
                                    child: Padding(
                                      padding: const EdgeInsetsDirectional.fromSTEB(
                                          0.0, 12.0, 0.0, 0.0),
                                      child: Text(
                                        'Não se preocupe,  você pode recuperar sua senha a qualquer momento, basta inserir o email da sua conta abaixo. ',
                              ...
                              onPressed: () async {
                                ...
                                await showDialog(
                                  ...
                                  builder: (alertDialogContext) {
                                    return WebViewAware(
                                      child: AlertDialog(
                                        title: const Text('Falta pouco!'),
                                        content: const Text(
                                            'Confira a sua caixa de entrada ou spam, depois, basta clicar no link e recuperar sua senha!'),
                                        actions: [
                                          TextButton(
